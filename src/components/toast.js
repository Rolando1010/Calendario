...
const Toast = (props) => {
    ...
    return (
        <div className="position-fixed bottom-0 end-0 toast-alert" style={{display: getDisplay, marginBottom: props.styleAdapter && "10px"}}>
            ...
            <div className="toast-header toast-alert-header" style={props.styleAdapter && {paddingBottom: "15px"}}>
            ...
            <div className="toast-body toast-alert-body" style={props.styleAdapter && {paddingBottom: "10px"}}>
            {getSuccess ? 
                ...
                :
                    <div className="alert alert-message alert-danger d-flex align-items-center" role="alert" style={props.styleAdapter && {paddingBottom: "20px"}}>
